...
class PanelCreator(var weaponPickerDialog: UIPanelAPI, var openedFromCampaign: Boolean, var docked: Boolean) {
    ...
    var simControllerElement: CustomPanelAPI? = null
    ...
    fun init() : CustomPanelAPI {
        ...
        if (openedFromCampaign && RFSettings.enableWeaponSimulation!!) {
            addSimulationTrigger(mainElement)
        }
